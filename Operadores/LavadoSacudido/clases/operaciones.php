...
$selecionarlistamaquinado="SELECT * FROM LISTALAVADOSACUDIDO WHERE LAVADOSACUDIDO_idLAVADOSACUDIDO=$idmaquinado";
...
echo '<div class="row">';
     ...
     $selecionartareas="SELECT * FROM TIEMPOLAVADO WHERE LAVADOSACUDIDO_idLAVADOSACUDIDO=$idmaquinado AND Final IS NULL";
