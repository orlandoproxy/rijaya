...
trait Insercion
{
    ...
    protected function cargar(array $columnas, array $valores, $tabla)
    {
        $cadenaValores = $this->tratandoColumnas($valores);
        $cadenaColumnas = $this->tratandoColumnas($columnas);
        $insertar = $this->Conexion->prepare("INSERT INTO $tabla ($cadenaColumnas) VALUES ($cadenaValores)");
        $insertar->execute();
    }
}
