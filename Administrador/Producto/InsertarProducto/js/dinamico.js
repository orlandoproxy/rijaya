...
function AgregarCampo()
{
	...
	NuevoCampo.innerHTML=
		...
		+"<td>"
			...
			+"<input type='checkbox' class='checkbox-inline' name='Proceso"+campo+"[]' value='Punteado' id='punteado_"+campo+"'>Punteado, "
			+"<input type='checkbox' class='checkbox-inline' name='Proceso"+campo+"[]' value='SoldaduraMig' id='soldaduramig_"+campo+"'>Soldadura Mig, "
			+"<input type='checkbox' class='checkbox-inline' name='Proceso"+campo+"[]' value='Lavado Sacudido' id='lavado_sacudido_"+campo+"'>Lavado Sacudido, "
			+"<input type='checkbox' class='checkbox-inline' name='Proceso"+campo+"[]' value='Pintura' id='Pintura_"+campo+"'>Pintura, "
			+"<input type='checkbox' class='checkbox-inline' name='Proceso"+campo+"[]' value='Terminado' id='terminado_"+campo+"'>Terminado, "
		+"</td>"
		+"<td>"
